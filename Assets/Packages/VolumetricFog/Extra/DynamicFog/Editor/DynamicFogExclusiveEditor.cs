...
namespace DynamicFogAndMist
{
    ...
    public class DynamicFogExclusiveEditor : Editor
    {
        ...
        SerializedProperty profileSync, effectType, preset, useFogVolumes, enableDithering, ditherStrength, useSinglePassStereoRenderingMatrix;
        ...
        void OnEnable()
        {
            ...
            profileSync = serializedObject.FindProperty("_profileSync");
